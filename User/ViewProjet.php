                                ...
                                <div class="table-responsive">
                                    <table class="table table-striped table-bordered first">
                                        ...
                                        <tbody>
                                            ...
                                            $resultat1 = mysqli_query($connexion ,"SELECT  p.id_projet,nom_projet,statut,r.id_respo,p.id_respo,nom_respo,prenom_respo,s.id_stagiaire FROM projet p ,responsable r, detail_stage d, stagiaire s WHERE p.id_respo=r.id_respo  and d.id_projet=p.id_projet and d.id_stagiaire=s.id_stagiaire and d.id_stagiaire='".$_GET['id']."' ");
