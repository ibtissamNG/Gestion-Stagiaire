            ...
            <div class="container-fluid  dashboard-content">
                <div class="row">
                    ...
                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                        <div class="card">
                            <h2 class="card-header">Projets en Cours</h2>
                                ...
                                <div class="table-responsive">
                                    <table class="table table-striped table-bordered first">
                                        ...
                                        <tbody>
                                            ...
                                            $resultat1 = mysqli_query($connexion ,"SELECT id_projet , nom_projet,statut ,r.id_respo ,p.id_respo ,nom_respo , prenom_respo FROM projet p ,responsable r WHERE p.id_respo=r.id_respo and statut like 'En cours'");
