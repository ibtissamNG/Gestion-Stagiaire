                                ...
                                <div class="table-responsive">
                                    <table class="table table-striped table-bordered first">
                                        ...
                                        <tbody>
                                            ...
                                            $resultat1 = mysqli_query($connexion ,"SELECT id_projet , nom_projet,statut ,r.id_respo ,p.id_respo ,nom_respo FROM projet p ,responsable r WHERE p.id_respo=r.id_respo");
                                                while($ligne = mysqli_fetch_object($resultat1)) {
                                                echo '<tr align="center"><td class="class2">'. $ligne->nom_projet.'</td><td class="class2">'. $ligne->statut.'</td><td class="class2">'. $ligne->nom_respo.'</td><td><a onclick="deleteProj('. $ligne->id_projet.')"  name="Delete" class="cc1"><i class="fas fa-trash-alt"></i></a>&nbsp&nbsp&nbsp<a onclick="updateProj('.$ligne->id_projet.')"  name="update" class="cc2"><i class="fa fa-pencil"></i></a> </td> 
